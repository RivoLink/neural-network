...
public class Network1HiddenTest {

    public static void main(String[] args) {
        System.out.println("=== Neural Network Test (1 Hidden Layer) ===");
        System.out.println();
    ...
    private static void testXORProblem() {
        System.out.println("Test 1: XOR Problem (2-4-1 network)");
        System.out.println("Training a 2-4-1 network to learn XOR...");
        System.out.println();

        // 2 inputs, 4 neurons in hidden layer, 1 output
    ...
    private static void testANDProblem() {
        System.out.println("Test 2: AND Problem (2-4-1 network)");
        System.out.println("Training a 2-4-1 network to learn AND...");
        System.out.println();

        Network andNetwork = new Network(2, 4, 1);
    ...
    private static void testORProblem() {
        System.out.println("Test 3: OR Problem (2-4-1 network)");
        System.out.println("Training a 2-4-1 network to learn OR...");
        System.out.println();

        Network orNetwork = new Network(2, 4, 1);
